        ...
        <div>
            <div className="navbar bg-gradient-to-r from-indigo-800  to-purple-800 dark:text-slate-300 text-white">
                <div className="navbar-start">
                    ...
                    <Link to="/" ><img src={logo} className="w-full md:w-6/12 active:text-white" alt="" /></Link>
                </div>
                ...
                <div className="navbar-end">
                    <div >
                        <label className="theme-switch">
                            <input onClick={handleModeChange} type="checkbox" name="checkbox" className="theme-switch__checkbox" id="toggleButton" />
                    ...
                    </div>
                    {
                            ...
                            <div className="flex">
                                <div className="flex-none">
                                    <div className="dropdown dropdown-end">
                                        ...
                                        <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52  bg-gradient-to-r from-indigo-800 to-purple-800 shadow">
                                ...
                                <div className="dropdown dropdown-end">
                                    ...
                                    <ul tabIndex={0} className=" space-y-3
                        ...
                        menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                        {
                                            user.displayName &&
                                            <li className="text-center text-2xl font-bold">{user.displayName}</li>
                                        }
                            ...
                            <div className="ml-4">
                                {
                                    !user &&
                                    <button className="px-4 py-2 rounded bg-violet-600 hover:bg-violet-800 border-none text-white"><Link to="/login">Login</Link></button>
                                }
                            </div>
