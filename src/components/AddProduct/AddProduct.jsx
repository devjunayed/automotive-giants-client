...
const AddProduct = () => {
    const [selectedCarType, setSelectedCarType] = useState('Suv');
    ...
    const handlSubmit = (event) => {
        ...
        fetch("https://automotive-giants-szycu79ub-devjunayeds-projects.vercel.app", {
            method: "POST",
            headers: {
    ...
    return (
        <div>
            <h1 className="text-black dark:text-zinc-400 text-3xl md:text-5xl text-center my-4 md:my-10">Add a <span className="text-purple-600">Car</span></h1>
                ...
                <div className="card  w-full max-w-md md:max-w-2xl lg:max-w-2xl shadow-2xl">
                    <form className="card-body" onSubmit={handlSubmit}>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                className="bg-white dark:bg-slate-800 input input-bordered"
                                name="imageUrl"
                                type="text"
                        ...
                        <div className="flex justify-center gap-4 ">
                            ...
                            <div className="w-full">
                                ...
                                <input
                                    className="bg-white dark:bg-slate-800 input input-bordered w-full"
                                    name="name"
                                    type="text"
                                    placeholder="name"
                                    required
                        ...
                        <div className="form-control">
                            ...
                            <textarea placeholder="Write description here...." className="bg-white dark:bg-slate-800 border resize-none p-4" name="description" id="" cols="20" rows="5"></textarea>
                        </div>
                        {/* Rating */}
                        <div className="form-control">
                            <label className="label">
